...
export const Home = () => {
	...
	return (
		<div className="container mt-5 text-light">
			...
			<div className="overflow-x-auto horizontal-scroll"style={{backgroundImage: `url(${backgroundImage})`}}>
			...
			<div className="d-flex overflow-x-scroll horizontal-scroll" style={{backgroundImage: `url(${backgroundImage})`}}>
